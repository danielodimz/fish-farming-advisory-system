...
jQuery(function($) {
    ...
    $(document).ready(function() {
        var e = '<div class="prt_floting_customsett">' +
            ...
            '<a href="http://localhost/web/fish-farming-advisory-system/header-overlay.php" class="tmtheme_fbar_icons"><i class="themifyicon themifyicon fa fa-home"></i><span>Homepage</span></a>' +
